...
class Matrix{
    ...
    void LastStatus(){
        try{
            FileWriter fw=new FileWriter("LastStaus.txt",true);
            BufferedWriter bw=new BufferedWriter(fw);
            PrintWriter pw=new PrintWriter(bw);
            FileReader fr=new FileReader("Matrix.txt");
            BufferedReader br=new BufferedReader(fr);
            if(br.readLine()!=null){
                pw.print(p);CreateMatrix();}
            pw.close();
        }
    ...
    boolean Seating(char ch,int no){
        try{
            FileReader fr=new FileReader("Seatno.txt");
            BufferedReader br=new BufferedReader(fr);
    ...
    void Choice(){
        LastStatus(); //later do it via object creation
        try{
            FileWriter fw=new FileWriter("Seatno.txt",true);
            BufferedWriter bw=new BufferedWriter(fw);
            PrintWriter pw=new PrintWriter(bw);
